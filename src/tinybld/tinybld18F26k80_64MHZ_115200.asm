...
baud EQU 115200			; standard TinyBld baud rates: 115200 or 19200
	...
	#define first_address max_flash-200		;100 words
    	...
    	CONFIG	RETEN = OFF, INTOSCSEL = HIGH, SOSCSEL = DIG, XINST = OFF
		CONFIG	FOSC = HS2, PLLCFG = ON, FCMEN = ON, IESO = ON
		CONFIG	PWRTEN = ON, BOREN = SBORDIS, BORV = 0, BORPWR = ZPBORMV
		CONFIG	WDTEN = ON, WDTPS = 128
		CONFIG	CANMX = PORTB, MSSPMSK = MSK7, MCLRE = ON
		CONFIG	STVREN = ON, BBSIZ = BB2K
